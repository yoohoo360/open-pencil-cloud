...
export const panelMessageDefaults = {
  ...
  createdInThisFile: 'Created in this file',
  builtinLibrary: 'Built-in',
  builtinText: 'Rich text',
  headingText: 'text',
  ...
  addMoreLibraries: 'Add more libraries',
  noRemoteLibraries: 'No remote libraries',
  ...
  addComponentProperty: 'Add property',
  ...
  propertyTypeSlot: 'Slot',
  applyBooleanProperty: 'Apply boolean property',
  detachBooleanProperty: 'Detach boolean property',
  noBooleanProperties: 'No boolean properties',
  applyTextProperty: 'Apply text property',
  detachTextProperty: 'Detach text property',
  noTextProperties: 'No text properties',
  applyInstanceSwapProperty: 'Apply instance swap property',
  detachInstanceSwapProperty: 'Detach instance swap property',
  noInstanceSwapProperties: 'No instance swap properties',
  applySlotProperty: 'Apply slot property',
  detachSlotProperty: 'Detach slot property',
  boundToProperty: params('Bound to {name}'),
  appliedToLayer: params('Applied to {name}'),
  noSlotProperties: 'No slot properties',
  createProperty: 'Create property',
  slotDescription: 'Description',
  slotDescriptionPlaceholder: 'How to use this slot',
  slotSettings: 'Settings',
  slotMinimumLayers: 'Minimum layers',
  slotMaximumLayers: 'Maximum layers',
  slotLayersNone: 'None',
  slotOnlyPreferredInstances: 'Only allow preferred instances',
  slotEmptyByDefault: 'By default, display empty slot',
  slotFillCounterAxis: "By default, fill items on slot's counter axis",
  slotPreferredInstances: 'Preferred instances',
  slotLearnMore: 'Learn more',
  addPreferredInstance: 'Add preferred instance',
  addSlotInstances: 'Add instances',
  instanceSwapSlot: 'Slot',
  textContent: 'Content',
  defaultVariantPropertyName: 'Property 1',
  defaultVariantPropertyValue: 'Default',
  defaultBooleanPropertyName: 'Boolean',
  defaultTextPropertyName: 'Text',
  defaultInstanceSwapPropertyName: 'Instance',
  defaultSlotPropertyName: 'Slot',
  ...
  allowLocalFonts: 'Allow local fonts',
  localFontsPrompt: 'Allow local font access to browse installed fonts.',
  localFontsDenied: 'Local font access is blocked for this site.',
  localFontsUnsupported: 'Local fonts are not available in this browser.',
