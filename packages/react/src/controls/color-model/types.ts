...
import type { RekaColor } from '#react/controls/color-model/model'
...
export interface UseColorModelOptions {
  color: Color | (() => Color)
  okhcl?: OkHCLColor | null | undefined | (() => OkHCLColor | null | undefined)
  format?: ColorFieldFormat | undefined | (() => ColorFieldFormat | undefined)
