---
title: Componenti
description: Riferimento ai componenti per le primitive Vue headless in @open-pencil/react.
---

# Componenti

`@open-pencil/react` espone primitive strutturali headless per il cablaggio del canvas, UI di navigazione, pannelli proprietà e controlli di input mirati.
