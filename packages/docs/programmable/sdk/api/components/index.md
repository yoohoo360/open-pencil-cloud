---
title: Components
description: Component reference for headless Vue primitives in @open-pencil/react.
---

# Components

`@open-pencil/react` exposes headless structural primitives for canvas wiring, navigation UI, property panels, and focused input controls.
